...
![Przykład informacji na temat wbudowanych narzędzi w prompcie systemowym](images/ai_devs_4_generalized_prompt_context-b0d37dd2-5.png)
...
![Porównanie danych w prompcie systemowym oraz narzędziach](images/ai_devs_4_system_vs_tools-460b59a5-d.png)
...
![Informacje na temat sesji i kompresowanego kontekstu w instrukcji systemowej](images/ai_devs_4_session_state-aec5a223-1.png)
...
![Tabela prezentująca stopniową zmianę roli kodu oraz AI w logice aplikacji](images/ai_devs_4_balance-14cfebe4-5.png)
...
![Agentowe przeszukiwanie dokumentów na podstawie obserwacji](images/ai_devs_4_search-389e2566-1.png)
...
![Przykłady instrukcji sterujących agentem przy eksplorowaniu treści](images/ai_devs_4_prompt_strategies-5cf00be6-4.png)
...
![Przykład gromadzenia kontekstu przez agenta](images/ai_devs_4_context_gathering-fec44b31-b.png)
...
![Agentic RAG](images/ai_devs_4_agentic_rag-7d824529-2.png)
...
![Przykład promptu z generalizowanymi zasadami](images/ai_devs_4_prompt_structure-6f64dd54-d.png)
...
![Przykład interakcji w której model wyjaśnia swoje zachowanie](images/ai_devs_4_explain-877db0a4-e.png)
...
![Iterowanie instrukcji i opisów narzędzi wspólnie z modelem](images/ai_devs_4_iteration-7ec2df6a-f.png)
...
![Optymalizacja promptu "przed" i "po"](images/ai_devs_4_transformation-7ef42b7d-5.png)
...
![Wizualizacja typowej interakcji z Agentem AI](images/ai_devs_4_typical_context_window-563eecaf-7.png)
...
![Przykładowa struktura okna kontekstowego i instrukcji w agencie do kodowania](images/ai_devs_4_coding_agent-ae869f7f-b.png)
...
![Zarządzanie kontekstem poza oknem kontekstowym](images/ai_devs_4_context_beyond_window-c8536bad-2.png)
...
![Przykład mechaniki przesłonięcia kontekstu](images/ai_devs_4_prefilling-f52cf34f-e.png)
...
![Przykład sterowania uwagą modelu poprzez powtórzenia w formie listy zadań](images/ai_devs_4_todo-381ad2b4-e.png)
...
![Przykład implementacji trybu planowania zadań](images/ai_devs_4_plan_mode-f92aa31c-f.png)
...
![Przykład struktury workspace'u dla agentów](images/ai_devs_4_workspaces-e68b7200-6.png)
