...
![Schemat Function Calling / Tool Use](images/ai_devs_4_function_calling-e9d7ae64-f.png)
...
![](images/ai_devs_4_function_calling-ef4b5aa4-e.png)
...
![Ogólna struktura i przykłady narzędzi do interakcji z systemem plików](images/ai_devs_4_filesystem_overview-5d0a8bea-2.png)
...
![](images/ai_devs_4_assembly-50a6ebc7-8.png)
...
![Połączenie natywnych i zewnętrznych narzędzi w LLM API](images/ai_devs_4_native_external_tools-801a06be-7.png)
...
![Przykład niebezpośredniego mapowania narzędzi LLM na podstawie API](images/ai_devs_4_mapping-66b46896-e.png)
...
![Przykład połączenia wielu zasobów API w jedno narzędzie](images/ai_devs_4_unified_tools-0da2d4fc-d.png)
...
![](images/ai_devs_4_mapping-1a8e7f3c-1.png)
...
![](images/ai_devs_4_defaults-3e061598-b.png)
...
![](images/ai_devs_4_validation-7a212262-e.png)
...
![Przykłady dodatkowych zabezpieczeń akcji, uwzględnionych wyłącznie dla kontekstu AI](images/ai_devs_4_constraints-b55f9156-5.png)
...
![](images/ai_devs_4_api_mcp_cli-ecf38a22-d.png)
...
![Przykład działania narzędzi bez kontekstu oraz ze spersonalizowanym kontekstem](images/ai_devs_4_augmented_tool_use-d76687f8-2.png)
...
![Przykład AI Workflow - Chain](images/ai_devs_4_chain-1c59a279-a.png)
...
![Przykładowa pętla logiki agenta](images/ai_devs_4_agent-d6370cf4-e.png)
...
![Agent Harness](images/ai_devs_4_agent_harness-0fed8955-3.png)
...
![](images/ai_devs_4_reasoning-3619585a-c.png)
...
![](images/ai_devs_4_query_transformation-c76cc21e-4.png)
...
![](images/ai_devs_4_context_based_transformation-cd67deaf-a.png)
...
![Przykłady optymalizacji obsługi narzędzi](images/ai_devs_4_optimization-8a52441d-2.png)
...
![Dynamiczne elementy instrukcji systemowej i wpływ na prompt cache](images/ai_devs_4_dynamic_context-67f5d208-5.png)
...
![Porównanie technik zarządzania kontekstem - pływające okno vs kompresja i filesystem](images/ai_devs_4_thread_context_management-ea50a552-a.png)
...
![Przykład zapisywania wyników działania narzędzi w formie plików dostępnych dla agenta](images/ai_devs_4_tool_results_as_files-999f9f03-e.png)
...
![Wizualizacja układu narzędzi dla subagentów oraz code execution](images/ai_devs_4_subagents_code_sandbox-ffee68d6-2.png)
...
![Zarządzanie dostępami, zgodami oraz danymi wejściowymi w deterministyczny sposób](images/ai_devs_4_permissions-395034b4-7.png)
...
![Przykład prompt injection w połączeniu z narzędziami agentów](images/ai_devs_4_prompt_injection-dce58564-8.png)
